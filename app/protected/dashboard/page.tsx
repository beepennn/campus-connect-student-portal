      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-primary to-accent rounded-lg p-8 text-primary-foreground">
            <h1 className="text-4xl font-bold mb-3">Welcome back, {user?.user_metadata?.full_name || 'Student'}!</h1>
            <p className="text-lg opacity-90">Stay connected with your campus community. Explore notices, materials, events, and announcements.</p>
          </div>
